...
def main():
    ...
    """
    # Load configuration
    config = load_config(config_path="config/train_config3.json")
    
    # Set output directory and checkpoint path
    output_dir = "eval_results/eval_results3"
    ...
    # Save results
    evaluator.save_results(results, filename="cetd_evaluation_results.json")
