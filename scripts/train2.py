...
def main():
    ...
    model = ICTransformer2(
        ...
        vit_model=model_cfg.get("vit_model", "vit_base_patch16_224"),
        hidden_size=model_cfg["hidden_size"],
        num_layers=model_cfg["num_decoder_layers"],
        num_heads=model_cfg["num_decoder_heads"],
    )

    print(f"Initialized ICTransformer2 model with {model_cfg.get('vit_model', 'vit_base_patch16_224')} backbone")
    ...
    print("Training of ICTransformer2 completed!")
